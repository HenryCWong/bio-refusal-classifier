...
# %% [markdown]
# # Biosecurity Refusal Classifier — RoBERTa
#
# A binary classifier that flags hazardous biosecurity prompts for refusal and
# passes everything else through.
#
# **Model:** `roberta-base`, fine-tuned for 3 epochs.
# RoBERTa keeps BERT's architecture but rebuilds the pretraining recipe — more
# data, longer training, larger batches, dynamic masking, and no NSP — which
# typically translates to a small but consistent gain on downstream tasks.
#
# **Labels:**
...
#
# ## Outputs
# - Trained checkpoint → `./roberta-biosec-classifier-output/`
...
training_args = TrainingArguments(
    output_dir="./roberta-biosec-classifier-output",
    learning_rate=2e-5,
...
# `./roberta-biosec-classifier-output/`. To reload and use it:
#
# ```python
# from transformers import AutoTokenizer, AutoModelForSequenceClassification
#
# tokenizer = AutoTokenizer.from_pretrained("./roberta-biosec-classifier-output")
# model = AutoModelForSequenceClassification.from_pretrained(
