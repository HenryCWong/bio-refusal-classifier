...
#
# A BERT-based binary classifier that flags hazardous biosecurity prompts for
# refusal and passes everything else through.
#
...
#
# ## Outputs
# - Trained checkpoint → `./bert-biosec-classifier-output/`
...
training_args = TrainingArguments(
    output_dir="./bert-biosec-classifier-output",
    learning_rate=2e-5,
...
# `./bert-biosec-classifier-output/`. To reload and use it:
#
# ```python
# from transformers import AutoTokenizer, AutoModelForSequenceClassification
#
# tokenizer = AutoTokenizer.from_pretrained("./bert-biosec-classifier-output")
# model = AutoModelForSequenceClassification.from_pretrained(
