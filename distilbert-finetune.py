...
# %% [markdown]
# # Biosecurity Refusal Classifier — DistilBERT
#
...
# DistilBERT is a distilled version of BERT — ~40% smaller and ~60% faster,
# retaining roughly 97% of BERT's GLUE performance. Useful as a lightweight
# deployment-time classifier.
#
# **Labels:**
...
#
# ## Outputs
# - Trained checkpoint → `./distilbert-biosec-classifier-output/`
...
training_args = TrainingArguments(
    output_dir="./distilbert-biosec-classifier-output",
    learning_rate=2e-5,
...
# `./distilbert-biosec-classifier-output/`. To reload and use it:
#
# ```python
# from transformers import AutoTokenizer, AutoModelForSequenceClassification
#
# tokenizer = AutoTokenizer.from_pretrained("./distilbert-biosec-classifier-output")
# model = AutoModelForSequenceClassification.from_pretrained(
